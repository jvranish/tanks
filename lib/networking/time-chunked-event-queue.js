...
- There also is the unit of time chunking you want to process incoming events in
  ...
  something like `requestAnimationFrame()` as actually frame rates will differ
...
export class TimeChunkedEventQueue {
  ...
  // TODO this function is a mess, find a simpler way to do this
